package org.apache.cassandra.gui;
...
import org.apache.cassandra.gui.gui.component.dialog.ConnectionDialog;
import org.apache.cassandra.gui.gui.component.dialog.listener.WindowCloseedListener;
import org.apache.cassandra.gui.gui.component.panel.ColumnTreePanel;
import org.apache.cassandra.gui.gui.component.panel.KeyspaceTreePanel;
import org.apache.cassandra.gui.gui.component.panel.PropertiesPanel;
import org.apache.cassandra.gui.gui.control.callback.PropertiesCallback;
import org.apache.cassandra.gui.gui.control.callback.RepaintCallback;
import org.apache.cassandra.gui.gui.control.callback.SelectedColumnFamilyCallback;
    ...
    public boolean createAndShow() {
        ...
        keyspaceTreePanel.setcCallback(new SelectedColumnFamilyCallback() {
            ...
            public void getCacllback(String keyspace, String columnFamily, String key) {
                columnTreePane.showRow(keyspace, columnFamily, key.getBytes());
            }
        });
        ...
        rightSplitPane.setLeftComponent(columnTreePane);
        rightSplitPane.setRightComponent(propertiesPane);
