...
import org.apache.cassandra.gui.gui.component.dialog.RingDialog;
import org.apache.cassandra.gui.gui.component.dialog.ShowConfigDialog;
    ...
    public void showColumnFamilyProperties(String keyspace, String columnFamily) {
        try {
            ...
            for (ColumnDef columnDef : columnDefs) {
				...
				tableModel.addRow(new String[] {"ColumnName", new String(columnDef.getName())});
				tableModel.addRow(new String[] {"IndexName", columnDef.getIndex_name()});
				tableModel.addRow(new String[] {"IndexType", columnDef.getIndex_type().name()});
				
			}
            
/*            for (Map.Entry<String, String> e : cfDef.entrySet()) {
